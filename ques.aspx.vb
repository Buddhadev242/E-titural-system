...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Session("QuestionSubject") = txtQuetionSubject.Text
        Session("QuestionType") = ddlqtype.SelectedValue.ToString
        Session("Questioncode") = txtQuestioncode.Text
